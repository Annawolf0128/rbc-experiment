...
SESSION_CONFIGS = [
    ...
    dict(
        name='rbc_small_low',
        display_name=f'RBC: 1 small group (1 × {GROUP_SIZE_SMALL}), low penalty (L={PENALTY_LOW})',
        app_sequence=['rbc'],
        num_demo_participants=GROUP_SIZE_SMALL,
        expected_session_size=GROUP_SIZE_SMALL,
    ...
    dict(
        name='rbc_small_high',
        display_name=f'RBC: 1 small group (1 × {GROUP_SIZE_SMALL}), high penalty (L={PENALTY_HIGH})',
        app_sequence=['rbc'],
        num_demo_participants=GROUP_SIZE_SMALL,
        expected_session_size=GROUP_SIZE_SMALL,
        group_size=GROUP_SIZE_SMALL,
    ...
    dict(
        ...
        display_name=f'RBC: 1 small group (1 × {GROUP_SIZE_SMALL}), low penalty (L={PENALTY_LOW}), belief elicitation',
        app_sequence=['rbc'],
        num_demo_participants=GROUP_SIZE_SMALL,
        expected_session_size=GROUP_SIZE_SMALL,
        group_size=GROUP_SIZE_SMALL,
