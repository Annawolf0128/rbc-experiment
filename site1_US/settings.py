...
SESSION_CONFIGS = [
    ...
    dict(
        name='rbc_small_low',
        display_name=f'RBC: 3 small groups (3 × {GROUP_SIZE_SMALL}; 15 participants), low penalty (L={PENALTY_LOW})',
        app_sequence=['rbc'],
    ...
    dict(
        name='rbc_small_high',
        display_name=f'RBC: 3 small groups (3 × {GROUP_SIZE_SMALL}; 15 participants), high penalty (L={PENALTY_HIGH})',
        app_sequence=['rbc'],
        num_demo_participants=GROUP_SIZE_LARGE,
        expected_session_size=GROUP_SIZE_LARGE,
        group_size=GROUP_SIZE_SMALL,
    ...
    dict(
        ...
        display_name=f'RBC: 3 small groups (3 × {GROUP_SIZE_SMALL}; 15 participants), low penalty (L={PENALTY_LOW}), belief elicitation',
        app_sequence=['rbc'],
        num_demo_participants=GROUP_SIZE_LARGE,
        expected_session_size=GROUP_SIZE_LARGE,
        group_size=GROUP_SIZE_SMALL,
