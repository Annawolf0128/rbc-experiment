...
SESSION_CONFIGS = [
    ...
    dict(
        name='rbc_small_low',
        display_name=f'RBC: small groups ({GROUP_SIZE_SMALL} per group; 15 default), low penalty (L={PENALTY_LOW})',
        app_sequence=['rbc'],
    ...
    dict(
        name='rbc_small_high',
        display_name=f'RBC: small groups ({GROUP_SIZE_SMALL} per group; 15 default), high penalty (L={PENALTY_HIGH})',
        app_sequence=['rbc'],
        num_demo_participants=SESSION_SIZE,
        group_size=GROUP_SIZE_SMALL,
    ...
    dict(
        ...
        display_name=f'RBC: small groups ({GROUP_SIZE_SMALL} per group; 15 default), low penalty (L={PENALTY_LOW}), belief elicitation',
        app_sequence=['rbc'],
        num_demo_participants=SESSION_SIZE,
        group_size=GROUP_SIZE_SMALL,
        penalty=PENALTY_LOW,
